"""Tests that CRUD service remotes."""
...
from pulp_service.tests.functional.constants import DOWNLOAD_POLICIES
...
from pulpcore.client.pulp_service import RemotesServiceApi
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remote_api = RemotesServiceApi(gen_service_client())
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/pulp/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(ApiException):
            RemotesServiceApi(gen_service_client()).create(body)
