"""Tests that publish service plugin repositories."""
...
from pulp_service.tests.functional.constants import SERVICE_CONTENT_NAME
...
class PublishAnyRepoVersionTestCase(unittest.TestCase):
    ...
    * `Pulp Smash #897 <https://github.com/pulp/pulp-smash/issues/897>`_
    ...
    def test_all(self):
        ...
        for service_content in get_content(repo.to_dict())[SERVICE_CONTENT_NAME]:
            modify_repo(cfg, repo.to_dict(), add_units=[service_content])
