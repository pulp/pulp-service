"""Regression for the calunga PULP-2120 failure: the *historical* broken-state repair.
...
def _shell(code):
    ...
    result = subprocess.run(["django-admin", "shell", "-c", code], check=True, capture_output=True, text=True)
