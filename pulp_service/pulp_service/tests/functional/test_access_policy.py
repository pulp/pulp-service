...
class TestPulpServiceAccessPolicyLoads:
    ...
    def test_inherits_from_access_policy_from_db(self):
        # This branch uses DB-backed RBAC (PULP-2120 alignment): each viewset's policy is
        # read from the DB, layered with PulpServiceAccessPolicy's cross-cutting pre-checks.
