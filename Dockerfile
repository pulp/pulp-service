...
COPY images/assets/patches/0004-Make-OSTree-repo-name-optional.patch /tmp/0004-Make-OSTree-repo-name-optional.patch
...
RUN patch -p2 -d /usr/local/lib/pulp/lib/python${PYTHON_VERSION}/site-packages/pulp_ostree < /tmp/0004-Make-OSTree-repo-name-optional.patch
