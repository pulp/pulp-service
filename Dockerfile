...
COPY images/assets/patches/0023-Add-the-task-name-to-the-task-log.patch /tmp/
RUN patch -p1 -d /usr/local/lib/pulp/lib/python${PYTHON_VERSION}/site-packages < /tmp/0023-Add-the-task-name-to-the-task-log.patch
