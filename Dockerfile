...
COPY images/assets/patches/0001-EXPERIMENT-Add-db_trigger-for-Task.pulp_created.patch /tmp/
RUN patch -p1 -d /usr/local/lib/pulp/lib/python${PYTHON_VERSION}/site-packages < /tmp/0001-EXPERIMENT-Add-db_trigger-for-Task.pulp_created.patch
