...
COPY images/assets/patches/0023-Add_db_trigger_for_Task-pulp_created.patch /tmp/
RUN patch -p1 -d /usr/local/lib/pulp/lib/python${PYTHON_VERSION}/site-packages < /tmp/0023-Add_db_trigger_for_Task-pulp_created.patch
