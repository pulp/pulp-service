...
COPY images/assets/patches/0014-Log-request.META-in-the-status-endpoint.patch /tmp/
RUN patch -p1 -d /usr/local/lib/pulp/lib/python${PYTHON_VERSION}/site-packages < /tmp/0014-Log-request.META-in-the-status-endpoint.patch
