...
COPY images/assets/patches/0019-Redirect-OTEL-when-signaled.patch /tmp/
RUN patch -p1 -d /usr/local/lib/pulp/lib/python${PYTHON_VERSION}/site-packages < /tmp/0019-Redirect-OTEL-when-signaled.patch
