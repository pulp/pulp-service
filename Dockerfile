...
COPY images/assets/patches/0023-Raise-an-exception-for-any-dispatched-task.patch /tmp/
RUN patch -p1 -d /usr/local/lib/pulp/lib/python${PYTHON_VERSION}/site-packages < /tmp/0023-Raise-an-exception-for-any-dispatched-task.patch
